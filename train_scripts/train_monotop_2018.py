...
# define all samples
input_samples.addSample(options.getDefaultName("monotop"), label = "monotop", normalization_weight = options.getNomWeight())
input_samples.addSample(options.getDefaultName("ttbar") , label = "ttbar" , normalization_weight = options.getNomWeight())
input_samples.addSample(options.getDefaultName("wjets") , label = "wjets" , normalization_weight = options.getNomWeight())
